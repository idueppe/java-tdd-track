...
@NamedQueries({
		...
		@NamedQuery(name = User.FIND_NO_CUSTOMER_MEMBER_BY_COMPANY_NAME, query = "SELECT u FROM User u, FleetGroup g "
				+ "WHERE u.role = de.crowdcode.vehicle.security.domain.Role.CUSTOMER "
